...
| P1-C | Битые превью скриншотов | ⏭ отменено — `<img screenshot>` в коде нет |
...
| P3-A | Eyebrow Hero на мобиле | ✅ (`whitespace-nowrap`) |
...
### P1-C. Битые превью скриншотов ⏭

Скриншоты — ссылки, не `<img>`. Закрыто без изменений.
...
### P3-A ✅ `Hero.tsx` — `whitespace-nowrap`.
...
Все пункты v2.1-A … v2.1-G выполнены (2026-07-06).
...
Исключения: P1-C (отменён), P2-E (не актуален).
