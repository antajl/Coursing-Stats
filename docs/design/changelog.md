...
## 2026-06-29: Dark mode для Stats компонента

**Проблемы:**
- В SpeedRecords/Stats.tsx текст единиц измерения ("км/ч", "сек") был чёрным в тёмной теме
- Проценты в статистике не имели правильных цветов для тёмной темы
- Таблицы статистики (по породам, полу, годам) имели чёрный текст в тёмной теме

**Решения:**
- Добавлены dark:text-charcoal-400 для единиц измерения во всех местах
- Добавлены dark:text-charcoal-400 для процентов в статистике
- Обновлены все таблицы статистики (по породам, полу, годам) с правильными цветами для тёмной темы

**Реализация:**
- Обновлён `frontend/src/pages/SpeedRecords/Stats.tsx`:
  - Статистика найденной собаки: добавлены dark: классы для "км/ч"
  - Общая статистика: добавлены dark: классы для "км/ч"
  - Таблица статистики по породам: добавлены dark: классы для "км/ч" и "сек"
  - Таблица статистики по полу: добавлены dark: классы для "км/ч" и "сек"
  - Таблица статистики по годам: добавлены dark: классы для "км/ч" и "сек"
  - Блок процентиль: добавлен dark: класс для текста процента
  - График распределения скоростей: добавлен dark: класс для текста процента

**Результат:**
- Весь текст в Stats компонента теперь корректно отображается в тёмной теме
- Единицы измерения и проценты имеют правильные цвета для тёмной темы
