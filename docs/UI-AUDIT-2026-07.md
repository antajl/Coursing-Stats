...
- [ ] **П4** — Зафиксировать правило толщины рамок, пройтись по компонентам
- [ ] **П8** — Облегчить шапку `DogProfile`
- [ ] **П6** — Унифицировать active-стиль Nav

### Фаза 3 — Токены (требует осторожности)

- [ ] **П1** — Аудит всех мест смешения CSS-переменных и Tailwind-классов
- [ ] **П7** — Заменить произвольные `rounded-[Npx]` на стандартные
