...
> **ВНИМАНИЕ:** Админка удалена из GitHub и доступна только локально. Документация оставлена для справки при локальной разработке.
...
**Статус:** Админка удалена из GitHub (frontend/src/pages/Admin/), но backend API (backend/src/routes/admin/) доступен локально для ручного редактирования данных через API.
