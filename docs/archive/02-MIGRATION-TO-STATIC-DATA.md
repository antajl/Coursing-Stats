...
> **Статус:** Исторический документ. Миграция выполнена в июле 2026.
>
> Для текущего состояния системы см. [03-DATA.md](../03-DATA.md) и [02-ARCHITECTURE.md](../02-ARCHITECTURE.md).
