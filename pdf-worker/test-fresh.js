...
const testPdfUrl = 'https://rkf.online/static/files/reports/100051.pdf?' + Date.now(); // Timestamp для обхода кеша

async function testWorker() {
  try {
    console.log('Testing worker with FRESH PDF (100051):', testPdfUrl);
