...
describe('multi-judge compact archive 2023', () => {
  it.skipIf(!fs.existsSync('data/archive/results/2023/Complete_Results_2023-04-15_B.html'))('event 1202 BZMP: 2 judges, bib colors, heat 2 bib 18', async () => {
  ...
  it.skipIf(!fs.existsSync('data/archive/results/2023/Complete_Results_2023-04-22.html'))('event 1428 coursing: 3 judges per heat', async () => {
