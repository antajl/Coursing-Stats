 ...
 *
 * Usage:
 *   yarn run import-archive-results-local
 *   yarn run import-archive-results-local -- --dry-run
 *   yarn run import-archive-results-local -- --year 2024
 *   yarn run import-archive-results-local -- --force
 */
