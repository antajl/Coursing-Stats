...
const COMPETITIONS_DIR = path.join(ROOT, 'data/v1/competitions/2023');
const DOGS_DIR = path.join(ROOT, 'data/v1/dogs/by-id');

console.log('Checking what results cannot be matched to dogs...');
...
// Process 2023 competition files
...
console.log(`\n=== Unmatched Results Sample (first 20) ===`);
unmatchedResults.slice(0, 20).forEach((r, i) => {
