...
export const HUB_PAGES: HubMeta[] = [
  {
    ...
    description:
      'Coursing Stats — вся карьера вашей собаки в одном месте: выступления, награды, рейтинги и экспертные оценки. Курсинг, бега и выставки с 2015 года.',
    h1: 'Статистика курсинга, бегов и выставок собак',
    paragraph:
      'Вся карьера вашей собаки в одном месте: выступления, награды, рейтинги и экспертные оценки. Курсинг, бега и выставки с 2015 года.',
  },
  {
    path: '/competitions',
  ...
  },
  {
    ...
    paragraph:
      'Две отдельные таблицы: замер скорости (км/ч) и бега борзых на 350 м (секунды). Данные с полигона Курсинг Донино.',
  },
  {
    path: '/guide',
