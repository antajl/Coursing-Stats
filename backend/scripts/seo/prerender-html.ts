...
export const HUB_PAGES: HubMeta[] = [
  {
    ...
    description:
      'Вся карьера собаки: выступления, награды, рейтинги по курсингу и выставкам РКФ. Данные с 2015 года.',
  ...
  {
    path: '/competitions',
    title: 'Рейтинг собак по курсингу и бегам | Coursing Stats',
    description:
  ...
  {
    path: '/speed-records',
    title: 'Рекорды Донино: скорость и бега 350 м | Coursing Stats',
    description:
      'Рекорды полигона Курсинг Донино: замер скорости (км/ч) и бега 350 м (сек). Таблицы по породам и статистика.',
