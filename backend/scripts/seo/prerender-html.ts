...
export const HUB_PAGES: HubMeta[] = [
  ...
  },
  {
    ...
    description:
      'Рейтинг собак по местам и очкам (курсинг, БЗМП, бега борзых), медальный зачёт и статистика судей. Данные с 2015 года.',
    h1: 'Рейтинг собак: курсинг и бега борзых',
    paragraph:
      'Два отдельных рейтинга — по местам (медали) и по очкам (индекс CS), плюс статистика судей. Источник протоколов — procoursing.ru.',
  },
  {
    path: '/shows',
