/**
 * Zod схемы для валидации результатов БЗМП
 */

import { z } from 'zod';

// Схема для результата собаки (БЗМП использует упрощенную структуру)
export const BzmpDogResultSchema = z.object({
...
// Схема для полного ответа парсера БЗМП
export const BzmpParseResultSchema = z.object({
  results: z.array(BzmpDogResultSchema),
