  ...
  return (
    <div className="p-4">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-charcoal-800 mt-2">{judgeData.judge_name}</h1>
        <p className="text-old-money-600">Детальная статистика оценок</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 border border-old-money-200 mb-6">
        <h2 className="text-xl font-bold text-charcoal-800 mb-4">Статистика по породам</h2>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 border border-old-money-200">
        <h2 className="text-xl font-bold text-charcoal-800 mb-4">Статистика по критериям</h2>
