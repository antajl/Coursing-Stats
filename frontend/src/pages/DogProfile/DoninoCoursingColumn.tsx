...
export function DoninoCoursingColumn({
  ...
  return (
    <div className="flex min-w-0 flex-col gap-4">
      <div className="flex h-[24rem] shrink-0 flex-col overflow-hidden rounded-xl border border-forest-200 bg-white p-5 md:h-[25rem] md:p-6">
        <h2 className="mb-4 shrink-0 text-lg font-bold tracking-tight text-charcoal-800 md:text-xl">
          Бега борзых (350 м)
        </h2>

        <div className="mb-4 flex h-[7.25rem] shrink-0 flex-col items-center justify-center rounded-lg border border-forest-200 bg-forest-50/80 p-4 text-center">
      ...
      {coursingStats.history.length > 0 && (
        <div className="rounded-xl border border-forest-200 bg-white p-5 md:p-6">
