    ...
    <div className="space-y-4">
      ...
      <SectionCard title="Как устроен рейтинг на сайте">
        <p>
          ...
          <strong>один список</strong>: на карточке медали, индекс CS и Elo.
        </p>
      ...
      <SectionCard title="Формула Elo (v2)">
        ...
        <ul className="list-inside list-disc space-y-1 pl-1 text-[13px] text-charcoal-600 dark:text-charcoal-300">
          ...
          <li>
            Elo показывается в едином списке на карточке, но <strong>не участвует в сортировке</strong> мест.
          </li>
        </ul>
      </SectionCard>
      ...
      <SectionCard title="Три показателя — один список">
        ...
        <ul className="list-inside list-disc space-y-1 pl-1 text-[13px] text-charcoal-600 dark:text-charcoal-300">
          ...
          <li>
            <strong>Elo</strong> — сила через соперников; на карточке как справка, на место не влияет.
          </li>
        </ul>
