...
export const SHOW_EVENT_AWARDS_PRIORITY = [
  ...
  },
  {
    ...
    note: 'Главный ринг (не путать с ЛЮ/ЛВ/ЛЩ/ЛБ породы). Награда дня, не замена JCAC для ЮЧР',
  },
  {
    rank: 4,
    abbr: 'ЛПП',
  ...
  },
  {
    ...
    note: 'Зависят от ранга выставки; 1× ЧРКФ может оформить титул Чемпион РКФ — выше обычного CW. КЧК — породы с НКП, КЧП — без НКП',
  },
  {
    rank: 10,
    abbr: 'CW',
...
export const SHOW_ABBREVIATIONS = [
  ...
  { abbr: 'НЯ', full: 'Неявка — заявка без старта в ринге' },
