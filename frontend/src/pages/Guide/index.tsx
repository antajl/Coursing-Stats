...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    label: 'Рейтинг',
    description:
      'Как устроен рейтинг Coursing Stats: медали и очки, индекс CS, отдельные таблицы по медалям и баллам.',
    keywords: 'рейтинг курсинг, индекс CS, рейтинг по медалям, рейтинг по очкам',
  },
  {
    id: 'site',
    label: 'О сайте',
