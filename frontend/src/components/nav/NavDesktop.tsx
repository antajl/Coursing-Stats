  ...
  return (
    <div className="hidden md:flex relative h-16 w-full items-center justify-between pl-2 pr-2 sm:pl-3 sm:pr-3 lg:pl-4 lg:pr-4">
      <Link
        to="/"
        ref={logoRef}
        className="flex min-w-0 shrink-0 items-center transition-opacity duration-[300ms] ease-linear"
        style={{
      ...
      <div
        ref={navCenterRef}
        className="absolute left-1/2 flex -translate-x-1/2 items-center gap-0.5 lg:gap-1"
      >
        <Link
          to="/"
