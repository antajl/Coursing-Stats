  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className={`h-9 px-4 py-2 border-2 rounded-xl hover:bg-old-money-50 focus:ring-2 focus:ring-gold-400 focus:border-transparent transition-all duration-300 shadow-sm font-medium flex items-center gap-2 ${
      ...
      {open && (
        <div id="filters-panel" className="absolute right-0 mt-2 w-[320px] md:w-[600px] max-w-[calc(100vw-2rem)] bg-white rounded-2xl shadow-2xl border-2 border-old-money-200 z-50 overflow-visible">
