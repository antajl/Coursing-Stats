  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className={`h-9 px-4 py-2 border-2 rounded-xl hover:bg-old-money-50 dark:hover:bg-charcoal-700 focus:ring-2 focus:ring-gold-400 focus:border-transparent transition-all duration-300 shadow-sm font-medium flex items-center gap-2 ${
