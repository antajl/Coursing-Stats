...
// Схемы для статических данных из data/v1
export const TopItemsResponseSchema = z.object({
  items: z.array(z.record(z.unknown())),
  count: z.number().optional(),
});

export const DogProfileDataSchema = z.object({
  schema: z.string(),
  ...
  dog: z.object({
    ...
    shows_stats: z.object({
      total_starts: z.number(),
      best_placement: z.number(),
      points: z.number(),
    }).optional(),
  }),
...
export type DogProfileData = z.infer<typeof DogProfileDataSchema>;
